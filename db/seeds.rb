...
20.times do
  ...
  meal = "dinner"
  Event.create(title: title, place: place, meal: meal, guest: guest, user: User.first)
end

# Event.create(place: "Amsterdam", title: "Le Wagon Batch 25 Meet Up", description: "Coolest dinnerparty ever. Ya know.", meal: "dinner", guest: "4", user: User.first)
# Event.create(place: "Amsterdam", title: "Vegan Party", description: "sadflkjsdf", meal: "breakfast", guest: "28", user: User.last)
...
20.times do
  Reservation.create(event: Event.first, user: User.first, message: "test message", video_url:"test.com", no_guests: 1)
end
